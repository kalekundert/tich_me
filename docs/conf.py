# -*- coding: utf-8 -*-
#
# tich_me documentation build configuration file, created by
...
version = tich_me.__version__
# The full version, including alpha/beta/rc tags.
release = tich_me.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'tich_me Documentation',
     [u'Kale Kundert'], 1)
]
